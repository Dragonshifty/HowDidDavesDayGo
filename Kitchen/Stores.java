...
public enum Stores {
    ...
    private Ingredient anchovies = new Ingredient();
    ...
    public int getAnchovies(){
        return anchovies.getQuantity();
    }

    public void setAnchovies(int amount){
        anchovies.setQuantity(amount);
    }
